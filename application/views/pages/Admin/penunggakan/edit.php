            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-12">
                    <?php foreach ($admin as $data) : ?>
                        <form method="post" class="needs-validation" action="<?php echo site_url('admin/penunggakan/update') ?>" novalidate="">
                            <div class="row">
                                <div class="col-12 col-md-8 col-lg-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <input id="id" type="hidden" class="form-control" name="id" tabindex="1" value="<?= $data->id_penunggakan ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="jumlah" type="text" name="jumlah" tabindex="1" class="form-control currency" value="<?= $data->bayar ?>" required readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
